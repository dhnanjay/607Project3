...
* Finally, the MySQL database was hosted via AWS RDS; the MySQL setup script can be located on the Github repository here: https://github.com/dhnanjay/607Project3/blob/master/sk_skills.sql 
